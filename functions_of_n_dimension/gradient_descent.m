%% Gradient descent
function [step_size1,point, output, time, iter] = gradient_descent(f, f_gradient, point, epsilon, max_iter)
...
for iter=1:max_iter
    ...
    step_size = armijo(f, point, step_size, gradient, -gradient, max_iter);
    %step_size=0.000005;
    %step_size=0.000002;
